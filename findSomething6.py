...
# Create a dedicated thread for frame display
...
flying = False
command_check_interval = 10  # check command every 50 frames
...
while True:
    try:
        ...
        if frame_counter % frame_skip == 0:  # Only process every 'frame_skip' frame
